...
angular.module('walleApp.ui')
  ...
  function accountRoute($stateProvider) {
    $stateProvider
      .state('login', {
        url: '/login',
        templateUrl: 'modules/core/client/app/account/login/index.html',
      ...
      .state('signup', {
        url: '/signup',
        templateUrl: 'modules/core/client/app/account/signup/index.html',
        controller: 'SignupController',
        controllerAs: 'vm'
      })
      .state('settings', {
        url: '/settings',
        templateUrl: 'modules/core/client/app/account/settings/index.html',
