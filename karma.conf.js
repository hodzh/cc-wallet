...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'modules/wallet/client/user/routes.ts',
      './modules/wallet/client/user/accounts/model.js',
      'modules/wallet/client/user/accounts/account.ts',
      ...
      'modules/wallet/client/admin/routes.ts',
      'modules/wallet/client/admin/main-menu.boot.ts',
      './modules/wallet/client/admin/account/schema.js',
      'modules/wallet/client/admin/account/account.resource.ts',
      ...
      'modules/core/client/components/email/email-input.component.html',
      'modules/core/client/components/footer/footer.component.html',
      './modules/core/client/components/modal/index.html',
      'modules/core/client/components/navbar/navbar.component.html',
      ...
      'modules/core/client/components/password/password-input.component.html',
      ...
      'modules/wallet/client/user/accounts/account.html',
      // endinject
    ],
