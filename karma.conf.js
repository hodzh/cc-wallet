...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      './modules/paygates/client/user/withdrawal-form/directive.js',
      './modules/paygates/client/user/withdrawal-form/controller.js',
      ...
      './modules/paygates/client/user/withdrawal-form/controller.spec.js',
      './modules/paygates/client/user/withdrawal-form/directive.spec.js',
      './modules/paygates/client/user/withdrawal-form/index.html',
